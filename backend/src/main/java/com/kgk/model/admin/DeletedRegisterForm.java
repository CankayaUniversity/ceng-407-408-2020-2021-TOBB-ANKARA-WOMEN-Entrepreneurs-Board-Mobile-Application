...
@Introspected
@DynamoDBTable(tableName = "DeletedRegisterForms")
public class DeletedRegisterForm {

    @NonNull
    private String deletedRegisterId; //hash key
    ...
    // Partition key
    @DynamoDBHashKey(attributeName = "deletedRegisterId")
    @DynamoDBAutoGeneratedKey
    @NonNull
    public String getDeletedRegisterId() {
        return deletedRegisterId;
    }

    public void setDeletedRegisterId(@NonNull String deletedRegisterId) {
        this.deletedRegisterId = deletedRegisterId;
    }
